...
*/
  ...
  for (i = 0; i < 10; i++)
  {
     draw_triangle(random(16), random(100)+640, random(100),
                   random(100)+640, random(100), random(100)+640, random(100), 1);
...
*/
     ...
     draw_triangle(random(16), random(100)+640, random(100),
                   random(100)+640, random(100), random(100)+640, random(100), 0);
  }
