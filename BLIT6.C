...
extern blit_8514(int x0, int y0, int x1, int y1, int colour, int shiftx, int shifty);
extern colour_blit_8514(int x0, int y0, int x1, int y1, int shiftx, int shifty);
